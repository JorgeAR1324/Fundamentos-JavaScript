...
console.log(a==b);
//En el operador && = Y deben cumplirse las 2 condiciones para que devuelva True

let pais, edad;
pais = prompt("Ingrese su pais de recidencia:");
edad = prompt("Ingrese su edad:");
if (pais == "Colombia" && edad >= 18) {
    console.log("Eres Colombiano")
    document.write("Eres Colombiano")
} else {
    console.log("No eres un ciudadano colombiano")
    document.write("No eres un ciudadano colombiano")
};

//Solicitar dia, mes, años y verificar si los valores son numericos
let day, month, year;
...
if (isNaN(day) || isNaN(month) || isNaN(year)) {
    document.write("Ingresa solamente numeros")
